...
export interface KafkaConnectS2ISpec {
   ...
   * JMX Options.
   *
   * @schema KafkaConnectS2ISpec#jmxOptions
   */
  readonly jmxOptions?: KafkaConnectS2ISpecJmxOptions;
 ...
 * JMX Options.
 *
 * @schema KafkaConnectS2ISpecJmxOptions
 */
export interface KafkaConnectS2ISpecJmxOptions {
  /**
   * Authentication configuration for connecting to the JMX port.
   *
   * @schema KafkaConnectS2ISpecJmxOptions#authentication
   */
  readonly authentication?: KafkaConnectS2ISpecJmxOptionsAuthentication;
...
export interface KafkaConnectS2ISpecLogging {
   ...
   * `ConfigMap` entry where the logging configuration is stored. 
   *
   * @schema KafkaConnectS2ISpecLogging#valueFrom
   */
  readonly valueFrom?: KafkaConnectS2ISpecLoggingValueFrom;
...
export interface KafkaConnectS2ISpecTemplate {
   ...
   * Template for the Kafka Connect ClusterRoleBinding.
   *
   * @schema KafkaConnectS2ISpecTemplate#clusterRoleBinding
   */
  readonly clusterRoleBinding?: KafkaConnectS2ISpecTemplateClusterRoleBinding;
 ...
 * Authentication configuration for connecting to the JMX port.
 *
 * @schema KafkaConnectS2ISpecJmxOptionsAuthentication
 */
export interface KafkaConnectS2ISpecJmxOptionsAuthentication {
  /**
   * Authentication type. Currently the only supported types are `password`.`password` type creates a username and protected port with no TLS.
   *
   * @schema KafkaConnectS2ISpecJmxOptionsAuthentication#type
   */
  readonly type: KafkaConnectS2ISpecJmxOptionsAuthenticationType;
 ...
 * `ConfigMap` entry where the logging configuration is stored. 
 *
 * @schema KafkaConnectS2ISpecLoggingValueFrom
 */
export interface KafkaConnectS2ISpecLoggingValueFrom {
  /**
   * Reference to the key in the ConfigMap containing the configuration.
   *
   * @schema KafkaConnectS2ISpecLoggingValueFrom#configMapKeyRef
   */
  readonly configMapKeyRef?: KafkaConnectS2ISpecLoggingValueFromConfigMapKeyRef;
...
export interface KafkaConnectS2ISpecTemplatePod {
   ...
   * Indicates whether information about services should be injected into Pod's environment variables.
   *
   * @schema KafkaConnectS2ISpecTemplatePod#enableServiceLinks
   */
  readonly enableServiceLinks?: boolean;
...
export interface KafkaConnectS2ISpecTemplateApiService {
   ...
   * Specifies the IP Family Policy used by the service. Available options are `SingleStack`, `PreferDualStack` and `RequireDualStack`. `SingleStack` is for a single IP family. `PreferDualStack` is for two IP families on dual-stack configured clusters or a single IP family on single-stack clusters. `RequireDualStack` fails unless there are two IP families on dual-stack configured clusters. If unspecified, Kubernetes will choose the default value based on the service type. Available on Kubernetes 1.20 and newer.
   *
   * @schema KafkaConnectS2ISpecTemplateApiService#ipFamilyPolicy
   */
  readonly ipFamilyPolicy?: KafkaConnectS2ISpecTemplateApiServiceIpFamilyPolicy;

  /**
   * Specifies the IP Families used by the service. Available options are `IPv4` and `IPv6. If unspecified, Kubernetes will choose the default value based on the `ipFamilyPolicy` setting. Available on Kubernetes 1.20 and newer.
   *
   * @schema KafkaConnectS2ISpecTemplateApiService#ipFamilies
   */
  readonly ipFamilies?: KafkaConnectS2ISpecTemplateApiServiceIpFamilies[];
...
export interface KafkaConnectS2ISpecTemplateBuildPod {
   ...
   * Indicates whether information about services should be injected into Pod's environment variables.
   *
   * @schema KafkaConnectS2ISpecTemplateBuildPod#enableServiceLinks
   */
  readonly enableServiceLinks?: boolean;
 ...
 * Template for the Kafka Connect ClusterRoleBinding.
 *
 * @schema KafkaConnectS2ISpecTemplateClusterRoleBinding
 */
export interface KafkaConnectS2ISpecTemplateClusterRoleBinding {
  /**
   * Metadata applied to the resource.
   *
   * @schema KafkaConnectS2ISpecTemplateClusterRoleBinding#metadata
   */
  readonly metadata?: KafkaConnectS2ISpecTemplateClusterRoleBindingMetadata;
...
export interface KafkaConnectS2ISpecBuildOutput {
   ...
   * Configures additional options which will be passed to the Kaniko executor when building the new Connect image. Allowed options are: --customPlatform, --insecure, --insecure-pull, --insecure-registry, --log-format, --log-timestamp, --registry-mirror, --reproducible, --single-snapshot, --skip-tls-verify, --skip-tls-verify-pull, --skip-tls-verify-registry, --verbosity, --snapshotMode, --use-new-run. These options will be used only on Kubernetes where the Kaniko executor is used. They will be ignored on OpenShift. The options are described in the link:https://github.com/GoogleContainerTools/kaniko[Kaniko GitHub repository^]. Changing this field does not trigger new build of the Kafka Connect image.
   *
   * @schema KafkaConnectS2ISpecBuildOutput#additionalKanikoOptions
   */
  readonly additionalKanikoOptions?: string[];
 ...
 * Authentication type. Currently the only supported types are `password`.`password` type creates a username and protected port with no TLS.
 *
 * @schema KafkaConnectS2ISpecJmxOptionsAuthenticationType
 */
export enum KafkaConnectS2ISpecJmxOptionsAuthenticationType {
  /** password */
  PASSWORD = "password",
}
 ...
 * Reference to the key in the ConfigMap containing the configuration.
 *
 * @schema KafkaConnectS2ISpecLoggingValueFromConfigMapKeyRef
 */
export interface KafkaConnectS2ISpecLoggingValueFromConfigMapKeyRef {
  /**
   * @schema KafkaConnectS2ISpecLoggingValueFromConfigMapKeyRef#key
   */
  readonly key?: string;

  /**
   * @schema KafkaConnectS2ISpecLoggingValueFromConfigMapKeyRef#name
   */
  readonly name?: string;

  /**
   * @schema KafkaConnectS2ISpecLoggingValueFromConfigMapKeyRef#optional
   */
  readonly optional?: boolean;
 ...
 * Specifies the IP Family Policy used by the service. Available options are `SingleStack`, `PreferDualStack` and `RequireDualStack`. `SingleStack` is for a single IP family. `PreferDualStack` is for two IP families on dual-stack configured clusters or a single IP family on single-stack clusters. `RequireDualStack` fails unless there are two IP families on dual-stack configured clusters. If unspecified, Kubernetes will choose the default value based on the service type. Available on Kubernetes 1.20 and newer.
 *
 * @schema KafkaConnectS2ISpecTemplateApiServiceIpFamilyPolicy
 */
export enum KafkaConnectS2ISpecTemplateApiServiceIpFamilyPolicy {
  /** SingleStack */
  SINGLE_STACK = "SingleStack",
  /** PreferDualStack */
  PREFER_DUAL_STACK = "PreferDualStack",
...
/**
 * @schema KafkaConnectS2ISpecTemplateApiServiceIpFamilies
 */
export enum KafkaConnectS2ISpecTemplateApiServiceIpFamilies {
  /** IPv4 */
  I_PV4 = "IPv4",
  /** IPv6 */
  I_PV6 = "IPv6",
 ...
 * Metadata applied to the resource.
 *
 * @schema KafkaConnectS2ISpecTemplateClusterRoleBindingMetadata
 */
export interface KafkaConnectS2ISpecTemplateClusterRoleBindingMetadata {
  /**
   * Labels added to the resource template. Can be applied to different resources such as `StatefulSets`, `Deployments`, `Pods`, and `Services`.
   *
   * @schema KafkaConnectS2ISpecTemplateClusterRoleBindingMetadata#labels
   */
  readonly labels?: any;
   ...
   * Annotations added to the resource template. Can be applied to different resources such as `StatefulSets`, `Deployments`, `Pods`, and `Services`.
   *
   * @schema KafkaConnectS2ISpecTemplateClusterRoleBindingMetadata#annotations
   */
  readonly annotations?: any;
